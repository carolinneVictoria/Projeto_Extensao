    ...
    <div class="container-fluid">
      <div class="collapse navbar-collapse d-flex justify-content-between" id="mynavbar">
        <ul class="navbar-nav mb-4 mb-lg-0">
          ...
          <li class="nav-item"><a class="nav-link" href="../FinanceiroView/contasPagas.php">Contas Pagas</a></li>
          <li class="nav-item"><a class="nav-link" href="../FinanceiroView/contasPendentes.php">Contas Pendentes</a></li>
          <li class="nav-item"><a class="nav-link" href="../FinanceiroView/formConta.php">Cadastrar nova Conta</a></li>
        </ul>
...
<!-- Listagem principal -->
<?php
// Inclui a conexão ao banco e o modelo de contas
...
// Listando as contas
$contas = $financeiroModel->listarPendentes();
