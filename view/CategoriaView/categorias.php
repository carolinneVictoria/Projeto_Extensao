    ...
    echo "
        <tbody>
            <tr>
                ...
                <a href=\"/Projeto_Extensao/controller/CategoriaController.php?acao=excluir&id={$idCategoria}\" class='btn btn-danger btn-sm' onclick=\"return confirm('A categoria possui associação com produtos. Dessa forma, se for excluida, excluira o produto também.')\">Excluir</a>
                </td>
            </tr>
        </tbody>
    ";
