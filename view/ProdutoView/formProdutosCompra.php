        ...
        <div class="col-lg-8">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white text-center">
                    <h4 class="mb-0">Cadastro de Produto para Compra</h4>
                </div>
                <div class="card-body">
                    <form action="../controller/ProdutoController.php?acao=cadastrarCompra&id=<?= htmlspecialchars($_GET['id']); ?>" method="POST" enctype="multipart/form-data" class="was-validated">
                        <div class="row g-3">
                            <div class="col-md-6">
